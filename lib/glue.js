...
var HotkeysImpl = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        hkToLower = info.hotkey.toLowerCase();
    ...
    HotkeysImpl.prototype.isRegistered = function (hotkey) {
        return this.hotkeys.has(hotkey.toLowerCase());
    };
